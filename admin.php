...
<html lang="en">
    ...
    <body>
    	...
    	<?php
			...
			// query to get the teams info from the database
			...
			// query to get the roles info from the database
			...
			// query to get id and name of a marble from the database
			...
			// query to get the marble info from the database
			...
			// query to get the placements from the database
			...
			// query to get the event info from the database
