...
<html lang="en">
    ...
    <head>
        <title> UPDATE MARBLE - Jelle's Marble Runs </title>
        <meta charset="utf-8">
    ...
    <body>
		...
		<div class="content">
    		<!-- opens php -->
    		<?php
				// query to update the marble info to the values submited from the admin page
				...
				// if the query doesn't work print not updated
				...
				// query to update the marble role info to the values submited from the admin page
				$update_competitors_roles = "UPDATE competitors_roles SET roles_id='$_POST[marble_role]' 
											WHERE competitor_id='$_POST[competitor_id]' 
											AND roles_id='$_POST[current_role]'";
				...
				if(!mysqli_query($conn, $update_competitors_roles))
				{
					...
					header("refresh:2; url = admin.php");
				// if the query does work print updated
				} else {
					echo 'Updated';
					header("refresh:2; url = admin.php");
				}
